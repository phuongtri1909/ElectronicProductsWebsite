...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/order_detail.css') }}" />
...
<body>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($order_products as $product)
                                            <tr>
                                                ...
                                                <td class="text-end">{{ number_format($product->ProductPrice, 0, '.', ',') }}
                                                    Đ</td>
                                            </tr>
                                        @endforeach
    ...
    <script src="{{ asset('js/all_order.js') }}"></script>
</body>
