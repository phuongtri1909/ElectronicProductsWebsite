        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <a class="btn btn-outline-success btn-sm" href="<?php echo e(route('properties.create')); ?>">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a>
                                        <?php echo e($value->propertiesName); ?>
                                ...
                                <td class="project-actions text-right">
                                            ...
                                            <form action="<?php echo e(route('editProperties')); ?>" method="post"
                                                enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                              
                                                <input hidden value="<?php echo e($value->id); ?>" type="text" id="idproperties"
                                    ...
                                    <form action="<?php echo e(route('properties.destroy',$value->id)); ?>" method="post"
                                        enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.header_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DoAnBe2\resources\views/layoutProduct/propertiesLP/all_properties.blade.php ENDPATH**/ ?>