            ...
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <p class="footer-content">Chào mừng đến với trang web bán đồ điện tử của chúng tôi - nơi cung
                            cấp hàng ngàn sản phẩm chất lượng với giá cả phải chăng.</p>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <span class="copyright">
                        ...
                        </script> All rights reserved | Created by <i class="fa fa-heart-o"
                            aria-hidden="true"></i> <a href="" target="_blank">3TDLStore</a>
...
<script src="<?php echo e(asset('js/selectedProperties.js')); ?>"></script>
<?php /**PATH E:\DoAnBe2\resources\views/layoutWebs/ft.blade.php ENDPATH**/ ?>