...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('css/link-not-found.css')); ?>" />
...
<body>
    ...
    <div class="notification">
        ...
        <a href="<?php echo e(route('3TDL Store')); ?>">Quay lại trang chủ</a>
      </div>
    </div>
    <?php echo $__env->make('layoutWebs.ft', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html><?php /**PATH E:\DoAnBe2\resources\views/website/link_not_found.blade.php ENDPATH**/ ?>