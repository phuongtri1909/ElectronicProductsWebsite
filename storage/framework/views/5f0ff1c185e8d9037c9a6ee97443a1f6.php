...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('css/detail.css')); ?>" />
                        ...
                        <div class="row">
                                    ...
                                    <div class="carousel-indicators">
                                        ...
                                        <?php for($i = 1; $i < count($product_image); $i++): ?>
                                            <button type="button" data-bs-target="#carouselExampleCaptions"
                                                ...
                                                aria-label="Slide <?php echo e($i); ?>"></button>
                                        <?php endfor; ?>
                                        ...
                                        <?php $__currentLoopData = $product_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($loop->first): ?>
                                                <div class="carousel-item active">
                                                    <img src="<?php echo e(asset('images/' . $image->product_imageName)); ?>"
                            ...
                            <div class="col-sm-4 bg-white" style="padding-left: 10px;">
                                ...
                                <h4 style="color: red; font-family:tahoma ;">
                                    <?php echo e(number_format($item->productPrice, 0, '.', ',')); ?>đ</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <form action="<?php echo e(route('cartProductBye')); ?>" method="POST"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <input hidden value="<?php echo e($item->id); ?>" type="text" id="product_id"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <form action="<?php echo e(route('cartProductAdd')); ?>" method="POST"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <input hidden value="<?php echo e($item->id); ?>" type="text" id="product_id"
                                                class="form-control" name="product_id" required autofocus>
                            ...
                            <div class=" col-sm-3 bg-white">
                                <table class="technicalInfo table table-striped">
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $productAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($value->attributteName); ?></td>
                                                <td><?php echo e($value->attributeValue); ?></td>
                            ...
                            <div class="col-sm-8 bg-white">
                                <div class="cps-block-content" style="max-height: 100000px;">
                                    <div class="ksp-content p-2 mb-2">
                                        ...
                                        <div>
                                            <ul>
                                                <li><?php echo e($item->descriptionProduct); ?></li>
...
<?php /**PATH E:\DoAnBe2\resources\views/website/detail_product.blade.php ENDPATH**/ ?>