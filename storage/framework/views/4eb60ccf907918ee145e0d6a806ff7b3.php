<div class="cotainer">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <form action="<?php echo e(route('addCategory.admin')); ?>" method="get" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH E:\DoAnBe2\resources\views/layoutProduct/addCategory.blade.php ENDPATH**/ ?>